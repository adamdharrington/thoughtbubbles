...
class ThoughtsControllerTest < ActionController::TestCase
  ...
  test "should create thought" do
    assert_difference('Thought.count') do
      post :create, thought: { email: @thought.email, sharecount: @thought.sharecount, thought: @thought.thought, url: @thought.url }
    end
  ...
  test "should update thought" do
    put :update, id: @thought, thought: { email: @thought.email, sharecount: @thought.sharecount, thought: @thought.thought, url: @thought.url }
    assert_redirected_to thought_path(assigns(:thought))
  end
