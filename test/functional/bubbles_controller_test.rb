...
class BubblesControllerTest < ActionController::TestCase
  ...
  test "should create bubble" do
    assert_difference('Bubble.count') do
      post :create, bubble: { category: @bubble.category, thought: @bubble.thought, title: @bubble.title, url: @bubble.url }
    end
  ...
  test "should update bubble" do
    put :update, id: @bubble, bubble: { category: @bubble.category, thought: @bubble.thought, title: @bubble.title, url: @bubble.url }
    assert_redirected_to bubble_path(assigns(:bubble))
  end
